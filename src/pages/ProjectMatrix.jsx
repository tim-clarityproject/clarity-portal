...
export default function ProjectMatrix() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, marginTop: '56px', display: 'flex', flexDirection: 'column', maxWidth: '1400px', marginTop: '56px', margin: '0 auto', width: '100%', padding: '64px 32px' }} className="page-container">
        ...
        <div style={{ flex: 1, marginTop: '56px', marginBottom: '48px', overflowX: 'auto' }}>
