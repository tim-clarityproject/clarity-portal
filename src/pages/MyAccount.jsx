...
export default function MyAccount() {
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, marginTop: '100px', display: 'flex', flexDirection: 'column', maxWidth: '900px', marginTop: '100px', margin: '0 auto', width: '100%', padding: '64px 32px' }} className="page-container">
        ...
        <div style={{ backgroundColor: 'white' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ flex: 1, marginTop: '100px', maxWidth: '60%' }}>
                <p style={{ fontSize: '14px', fontWeight: '600', color: '#333', margin: 0, marginBottom: '4px' }}>
                  Mission Statement
                </p>
